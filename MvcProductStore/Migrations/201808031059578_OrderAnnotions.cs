namespace MvcProductStore.Migrations
{
    ...
    public partial class OrderAnnotions : DbMigration
    {
        public override void Up()
        {
            ...
            AlterColumn("dbo.Orders", "City", c => c.String(nullable: false, maxLength: 70));
            AlterColumn("dbo.Orders", "State", c => c.String(maxLength: 70));
